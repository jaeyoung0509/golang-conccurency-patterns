...
const enSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Control Flow and Evaluation", link: "/extras/go-pitfalls/control-flow-and-evaluation" },
      { text: "Interfaces and Types", link: "/extras/go-pitfalls/interfaces-and-types" },
      { text: "Collections and Memory", link: "/extras/go-pitfalls/collections-and-memory" },
      { text: "Concurrency, Context, and Time", link: "/extras/go-pitfalls/concurrency-context-and-time" },
      { text: "Stdlib and API Boundaries", link: "/extras/go-pitfalls/stdlib-and-api-boundaries" },
...
const koSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Control Flow와 Evaluation", link: "/ko/extras/go-pitfalls/control-flow-and-evaluation" },
      { text: "Interfaces와 Types", link: "/ko/extras/go-pitfalls/interfaces-and-types" },
      { text: "Collections와 Memory", link: "/ko/extras/go-pitfalls/collections-and-memory" },
      { text: "Concurrency, Context, Time", link: "/ko/extras/go-pitfalls/concurrency-context-and-time" },
      { text: "Stdlib과 API Boundary", link: "/ko/extras/go-pitfalls/stdlib-and-api-boundaries" },
